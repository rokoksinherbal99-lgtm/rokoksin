...
export default function ProductsPageClient() {
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-8">
      ...
      <h1 className="text-3xl font-bold tracking-tight text-foreground">Semua Produk</h1>
      <p className="mt-2 text-sm text-muted-foreground">Jelajahi koleksi produk herbal kami.</p>
      ...
      <div className="mt-6 rounded-sm border border-[#25D366]/30 bg-[#25D366]/5 p-4">
        <div className="flex flex-col items-center gap-3 text-center sm:flex-row sm:text-left">
          ...
          <div>
            <p className="font-sans text-sm font-bold text-[#18181B]">Tidak yakin memilih produk?</p>
            <p className="font-sans text-xs text-[#52525B]">Chat kami langsung — kami bantu pilihkan yang paling cocok untuk Anda.</p>
          </div>
